...
public class AdSysPicDirAdapter extends BaseAdapter {
	...
	public AdSysPicDirAdapter(Activity act, List<AdSysPicDir> list) {
		this.act = act;
		dataList = list;
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			holder = new Holder();
			arg1 = View.inflate(act, R.layout.ad_fc_sys_picdir_item, null);
		...
		AdSysPicDir item = dataList.get(arg0);
