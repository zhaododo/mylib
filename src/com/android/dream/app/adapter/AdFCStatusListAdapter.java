 ...
 * 
 */
public class AdFCStatusListAdapter extends BaseAdapter {
	...
	final private AdFCStatusListAdapter adapter;
	 ...
	 * @param resource
	 */
	public AdFCStatusListAdapter(Context context, AppContext appContext, List<AdFriendStatusVo> data) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (item.getType() == UIHelper.FRINDS_CICLE_TYPE_CARD) {
			...
			if (convertView == null) {
				// 获取list_item布局文件的视图
				convertView = listContainer.inflate(R.layout.linkcontent, null);
				...
				listItemView.comment_tx_view = (TextView) convertView
						.findViewById(R.id.comment_tx_view);

				// 点赞分割线
				listItemView.zan_line = (View) convertView
						.findViewById(R.id.zan_line);
				// 回复列表
				...
				listItemView.add_replycontent = (TextView) convertView
						.findViewById(R.id.add_replycontent);
			...
			listItemView.zan_image.setOnClickListener(new ZanOnClick(item
					.getMainStatuId(),position));
			listItemView.zan_tx_view.setOnClickListener(new ZanOnClick(item
					.getMainStatuId(),position));
	...
	class ZanOnClick implements View.OnClickListener {
		...
		public ZanOnClick(String friendsMainId,int position) {
			this.friendsMainId = friendsMainId;
			this.position = position;
		}
		...
		public void onClick(View v) {
			...
			if (appContext != null)
			{
				addFriendZan(appContext.getCurrentUser(),appContext.getCurrentUserName(),friendsMainId,position);
				scaleAnimation(v);
			}
	...
	class CommentOnClick implements View.OnClickListener {
		...
		@Override
		public void onClick(View v) {
			dialogListener.setFriendsMainId(friendsMainId);
			dialogListener.setPosition(position);
			ciDialog.setListener(dialogListener);
			ciDialog.show();
		}
	}
