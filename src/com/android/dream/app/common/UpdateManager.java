package com.android.dream.app.common;
...
public class UpdateManager {
	...
	public void checkAppUpdate(Context context, final boolean isShowMsg){
		...
		new Thread(){
			public void run() {
				...
				try {					
					AdUpdate update = ApiClient.adGetVersion((AppContext)mContext.getApplicationContext());
					msg.what = 1;
					msg.obj = update;
	...
	private Runnable mdownApkRunnable = new Runnable() {	
		...
		public void run() {
			try {
				String apkName = "DreamApp_"+mUpdate.getVersionName()+".apk";
				String tmpApk = "DreamApp_"+mUpdate.getVersionName()+".tmp";
				//判断是否挂载了SD卡
				String storageState = Environment.getExternalStorageState();		
				if(storageState.equals(Environment.MEDIA_MOUNTED)){
					savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Dream/Update/";
