 ...
 * @created 2012-3-21
 */
public class NISCO_URLs implements Serializable {
	
	public final static String HOST = "172.18.43.37:8080";
	...
	public final static String USER_LIST = URL_API_HOST+"rest/service/users";
	
	public final static String LOGIN_VALIDATE = URL_API_HOST+"rest/service/twplogin";
	 ...
	 */
	public final static NISCO_URLs parseURL(String path) {
		if(StringUtils.isEmpty(path))return null;
		path = formatURL(path);
		NISCO_URLs urls = null;
		String objId = "";
		try {
