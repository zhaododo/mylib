...
import com.android.dream.app.adapter.AdFCStatusListAdapter;
 ...
 *
 */
public class AdFCFirendStatusActivity extends BaseActivity {

	private PullToRefreshListView pullListView;
	private AdFCStatusListAdapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		backBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(isTaskRoot()){
					...
					intent.setClass(AdFCFirendStatusActivity.this, AdMainActivity.class);
					startActivity(intent);
				}
				AdFCFirendStatusActivity.this.finish();
			}
		});
		...
		adapter = new AdFCStatusListAdapter(AdFCFirendStatusActivity.this,appContext,localfcstatus);
...
//			正在等待dialog
		...
		new Thread() {
			public void run() {
				...
				try {
//					加载朋友状态
					AdFriendStatusPageVo rslt = appContext.getFriendStatus(appContext.getCurrentUser(),pageIndex);				
