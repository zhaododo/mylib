...
public class PullToRefreshActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pull_list_content);
		...
		pull_listView.setOnScrollListener(new AbsListView.OnScrollListener() {
			...
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				...
				if(scrollEnd && lvDataState==UIHelper.LISTVIEW_DATA_MORE)
				{
					...
					Log.i(TAG, "setOnScrollListener pull_NewsSumData:"+pull_NewsSumData);
					//当前pageIndex
		...
		pull_adapter = new NewsPaginationAdapter(this,lvNewsData,R.layout.news_listitem);	
			...
			public void handleMessage(Message msg) {
				...
				if(msg.what >= 0){
					if(msg.what < pageSize){
						...
						Log.i(TAG, "handleMessage load_more");
					}
				}
				else if(msg.what == -1){
					//有异常--显示加载出错 & 弹出错误消息
					...
					switch (objtype) {
						case UIHelper.LISTVIEW_DATATYPE_NEWS:
							...
							if(actiontype == UIHelper.LISTVIEW_ACTION_REFRESH){
								...
								Log.i(TAG, "LISTVIEW_ACTION_REFRESH,lvNewsData ="+lvNewsData);
							}
				...
				case UIHelper.LISTVIEW_ACTION_SCROLL:
					switch (objtype) {
						case UIHelper.LISTVIEW_DATATYPE_NEWS:
							...
							Log.i(TAG, "LISTVIEW_ACTION_SCROLL");

							NewsList list = (NewsList)obj;
							pull_NewsSumData += what;
							
							Log.i(TAG, "LISTVIEW_ACTION_SCROLL,pull_NewsSumData="+pull_NewsSumData);
