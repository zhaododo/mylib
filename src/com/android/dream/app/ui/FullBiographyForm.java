...
public class FullBiographyForm extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fullbiography);

		et_personName = (EditText) findViewById(R.id.et_personName); // 姓名
		...
		isMarriedN = (TextView) findViewById(R.id.isMarriedN);
		isMarriedY = (TextView) findViewById(R.id.isMarriedY);
		...
		et_birthday = (EditText) findViewById(R.id.et_birthday); // 出生日期
		// 在editText的点击事件中增加日期选择器
		et_birthday.setOnClickListener(new DatePackClickListener());

		et_salary = (EditText) findViewById(R.id.et_salary); // 期望薪资
		et_salary.setOnClickListener(new SalaryDialogClickListener());

		et_experience = (EditText) findViewById(R.id.et_workExperience); //工作经验
		et_experience.setOnClickListener(new ExperDialogClickListener());
		
		commitBtn_fbf = (Button) findViewById(R.id.commitBtn_fbf);	//提交按钮
	...
	private class SalaryDialogClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			SalaryDialog dialog = new SalaryDialog(FullBiographyForm.this,
	...
	private class ExperDialogClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			ExperienceDialog dialog = new ExperienceDialog(FullBiographyForm.this,
