 ...
 *
 */
public class AdFCOperaPicActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ad_fc_op_status_photo);

		photo_relativeLayout = (RelativeLayout) findViewById(R.id.photo_relativeLayout);
		photo_relativeLayout.setBackgroundColor(0x70000000);

		for (int i = 0; i < AdFCBimp.bmp.size(); i++) {
			bmp.add(AdFCBimp.bmp.get(i));
		}
		for (int i = 0; i < AdFCBimp.drr.size(); i++) {
			drr.add(AdFCBimp.drr.get(i));
		}
		max = AdFCBimp.max;
