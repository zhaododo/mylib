...
public class PullToRefreshListView extends ListView implements OnScrollListener {  
    ...
    public PullToRefreshListView(Context context, AttributeSet attrs) {  
        super(context, attrs);  
        init(context);
        Log.i(TAG, "PullToRefreshListView(Context context, AttributeSet attrs)");
    }  
    
    public PullToRefreshListView(Context context, AttributeSet attrs, int defStyle) {  
        super(context, attrs, defStyle);  
        init(context);
        Log.i(TAG, "PullToRefreshListView(Context context, AttributeSet attrs, int defStyle)");
    }  
    ...
    private void changeHeaderViewByState() {  
        ...
        case RELEASE_To_REFRESH:  
            ...
            //Log.v(TAG, "当前状态，松开刷新");  
            Log.i(TAG, "RELEASE_To_REFRESH:lastUpdatedTextView:"+lastUpdatedTextView.getText().toString());
            break;  
